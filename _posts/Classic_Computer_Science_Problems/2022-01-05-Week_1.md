...
| 과정                                                         | 설명                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![](https://github.com/B31l/B31l.github.io/blob/master/img/Classic_Computer_Science_Problems/compress-03.png?raw=true) | 우선 주어진 문자열을 문자 단위로 분해한 다음, 각 문자가 등장하는 빈도수를 기준으로 오름차순으로 정렬한다. |
| ![](https://github.com/B31l/B31l.github.io/blob/master/img/Classic_Computer_Science_Problems/compress-04.png?raw=true) | 가장 작은 빈도수를 가진 두 문자 E, P를 자식 노드로 갖는 서브트리를 만든다. 이후 빈도수를 기준으로 다시 오름차순으로 정렬한다. |
| ![](https://github.com/B31l/B31l.github.io/blob/master/img/Classic_Computer_Science_Problems/compress-05.png?raw=true) | 가장 작은 빈도수 : X, 2                                      |
| ![](https://github.com/B31l/B31l.github.io/blob/master/img/Classic_Computer_Science_Problems/compress-06.png?raw=true) | 가장 작은 빈도수 : G, L                                      |
| ![](https://github.com/B31l/B31l.github.io/blob/master/img/Classic_Computer_Science_Problems/compress-07.png?raw=true) | 가장 작은 빈도수 : 3, O                                      |
| ![](https://github.com/B31l/B31l.github.io/blob/master/img/Classic_Computer_Science_Problems/compress-08.png?raw=true) | 가장 작은 빈도수 : 4, 6                                      |
| ![](https://github.com/B31l/B31l.github.io/blob/master/img/Classic_Computer_Science_Problems/compress-09.png?raw=true) | 트리가 완성되면 각각의 자식 노드를                           |
