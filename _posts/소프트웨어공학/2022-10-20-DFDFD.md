...
- 객체지향 방법 => 클래스 다이어그램 => Use case 사용
- 구조적 방법 => 모듈(module)의 계층구조 => **DFD**<sub>데이터 흐름도</sub> 사용

# 데이터 흐름도<sup>DFD<sub>(Data-flow diagram)</sub></sup>

| 📕 정의                                                       |
| ------------------------------------------------------------ |
| 시스템을 구성하는 프로세스 간의 데이터 흐름을 중심으로 처리과정을 분석하는 모형화 도구이다.<br>자료 흐름도라고도 한다. |
