...
Windows Terminal은 많은 기능과 우수한 편의성을 자랑하는 터미널입니다. 설치하지 않아도 텐서플로우 작업환경을 구성하는 데에는 전혀 문제가 없습니다.
Ubuntu 버전은 **Ubuntu 20.04.4 LTS**를 선택합니다. 설치가 완료되면 실행한 다음, **username** 및 **password**를 입력하는 초기 설정을 진행합니다.
...
Windows용 Docker 데스크톱은 [이곳](https://docs.docker.com/desktop/windows/install/)에서 설치할 수 있으며, 설치가 완료되면 실행한 다음 다음 사진과 같이 설정합니다.
General 메뉴의 Use the WSL 2 based engine 옵션에 체크합니다.![](https://github.com/B31l/B31l/blob/main/posts/DeepLearning/20220713_01.png?raw=true)
